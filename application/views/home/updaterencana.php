<?php $this->load->view('entryscript');?>
          ...
          <?php 
          $data = $this->getdata->getDataBy($id);
          $attributes = array('class' => 'form_inline', 'id' => 'myform', 'name' => 'entry');
          echo form_open('home/updaterencana/'.$id.'/'.$total, $attributes);
          ?>
                ...
                <div class="accordion-group">
                  ...
                  <div id="collapseOne" class="accordion-body collapse">
                    <div class="accordion-inner">
                      <table class="table">
                        <?php
                          $dataahp4 = $this->getdata->getahp4($id);
                        ...
                        <tr>
                          ...
                          <td><span class="add-on">Rp. </span><input name="bp" type="text" value="<?php echo $dataahp4->pengeluaran;?>"  placeholder="something…"></input><span class="add-on">,00</span></td>
                        </tr>
                      </table>
                    </div>
                  </div>
                    ...
                    <div class="accordion-inner">
                      <table class="table">
                        ...
                        <tr>
                          ...
                          <td><span class="add-on">Rp. </span><input name="atk4" type="text" value="<?php echo $data->atk4;?>" placeholder="something…" onFocus="startCalcAtk();" onBlur="stopCalcAtk();"></input><span class="add-on">,00</span></td>
                        </tr>
                         <tr>
                          <td>
